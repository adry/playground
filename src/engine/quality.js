...
export const TIERS = {
  high: { particles: 1.0, steps: 1.0, bloom: 5, samples: 4, label: 'high' },
  medium: { particles: 0.55, steps: 0.7, bloom: 4, samples: 4, label: 'medium' },
  draft: { particles: 0.3, steps: 0.5, bloom: 3, samples: 0, label: 'draft' },
};
